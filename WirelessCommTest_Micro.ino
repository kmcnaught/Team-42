...
void loop() {
  ...
  if (role == 1)
  {
    ...
    unsigned long start_time = 42;//micros();                      // Take the time, and send it.  This will block until complete
   ...
   //   Serial.println(got_time);
      if(got_time==0){
        ...
        digitalWrite(11,LOW);
          ...
          left_speed=(got_time/100);
          MotorL.write(left_speed+70);
          MotorR.write(got_time-left_speed*100+70);
          Serial.println(left_speed+70);
          Serial.println(got_time-left_speed*100+70);
      }      
    }
 }
