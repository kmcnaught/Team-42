...
def RobAligntoTgt(gcentre,TgtCentre, TgtAngle):  # !!! Align function should check if pathsis clear as well
    AngleTh = 15 
...
while(True):
    ...
    if GreenCheck == 0 or RedCheck == 0:
        ...
        if WhiteCheck == 1:
            ...
            if TgtCheck == 1:
                AlignCheck, command = RobAligntoTgt(gcentre,TgtCentre, TgtAngle )
            else:
